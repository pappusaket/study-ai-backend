...
async def root():
    return {
        ...
        "version": "3.0",
        "features": ["PDF Processing", "Text File Support", "Pure Hindi Answers", "SpeechSynthesis TTS"],
...
async def health():
    return {
        ...
        "features": ["Pure Hindi Q&A", "PDF Context", "Text File Support", "SpeechSynthesis TTS"]
    }
